...
export default function GradeList() {
  ...
  // Authorized Access Verification Modal for applying Maarif model curriculum
  ...
  // Yetkili Girişi Denetleyicisi: Yetkisiz kullanıcılardan şifre ister
  const handleProtectedMaarifAction = (action: () => void) => {
    if (isConverterAuthenticated()) {
      // Zaten geçerli yetkili oturumu var
      action();
    } else {
      // Yetkili şifresi doğrulaması gerekli
  ...
  const handleAuthSubmit = (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setAuthError('Hatalı yetkili şifresi! Maarif müfredatını kütüphaneye ekleme işlemi yalnızca yetkili öğretmen ve yöneticiler tarafından gerçekleştirilebilir.');
    }
  };
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full lg:w-auto shrink-0">
            <button
              type="button"
              onClick={() => handleProtectedMaarifAction(() => handleApplyMaarif('replace'))}
            ...
            >
              ...
              <span className="text-3xs bg-amber-500/40 text-primary-950 px-2 py-0.5 rounded-full border border-primary-950/20 flex items-center gap-1 font-semibold ml-1">
            ...
            >
              ...
              <div className="pt-4 mt-4 border-t border-primary-200 flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
                  ...
                  >
                    <Sparkles className="w-3.5 h-3.5 text-amber-300" />
                    <span>Bu Müfredatı Kütüphaneye Otomatik Ekle</span>
                    <span className="text-3xs bg-amber-400/20 text-amber-300 px-1.5 py-0.5 rounded border border-amber-300/30 flex items-center gap-0.5 font-normal ml-1">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
            ...
            >
              ...
              <h3 className="text-xl font-serif font-bold text-primary-950 mb-1.5">
                Maarif Modeli Kütüphane Yetkilendirmesi
              </h3>

              <p className="text-xs text-primary-800/80 mb-4 leading-relaxed">
                Maarif Modeli ünite ve alt konularını kütüphaneye otomatik olarak eklemek için lütfen yetkili şifrenizi giriniz.
              </p>
